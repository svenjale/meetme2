...
// implements View.OnClickListener wieder einfügen
    ...
    private void createevent() {
        ...
        if (!TextUtils.isEmpty(eventname)){
            ...
            databaseEventteilnehmer.child(id).child("teilnehmer"+event.teilnehmerAnzahl).setValue(organisatorID); // Johann: wahrscheinlich Problem, sobald mehrere Teilnehmer --> prüfen, sobald Eventinfos getestet werden kann
